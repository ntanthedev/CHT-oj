...
urlpatterns = [
    ...
    path('contest/<str:contest>', include([
        ...
        path('/moss/compute', contests.ComputeMoss.as_view(), name='compute_moss'),
    ...
    path('judge-select2/', include([
        ...
        path('problem/org/<int:org_pk>/', OrganizationProblemSelect2View.as_view(),
             name='org_problem_select2'),
